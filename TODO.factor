...
backlog: [
- Update README with run/install instructions
]
...
5:50a:  "Copy Existing GDForth v2 (aka GDForthComp) from private game"
5:46a:  "Copy GDForth v1 (aka GDForth) from private game"
